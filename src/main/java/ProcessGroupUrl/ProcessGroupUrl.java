...
public class ProcessGroupUrl {
    ...
    public ProcessGroupUrl() {
        ...
        this.process_group_url.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef78355a-015f-1000-56d5-37f8af22664c/processors");//Usage_dint
        ...
        this.process_group_url.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef7825d2-015f-1000-51ab-1024c6250f6e/processors");//Mail_dint
        ...
        this.process_group_url.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef78487a-015f-1000-ee70-20fee4dd9b73/processors");//User_dint
        ...
        this.process_group_url.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef786c82-015f-1000-8e57-8dfed41663d8/processors");//Commission_dint
       ...
       //this.process_group_url.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/f86d3856-fa7e-1972-6f7e-63f4ab0f6ab2/processors");//Subscription_ddach
        this.process_group_url.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef788922-015f-1000-9d93-7bb916a6f066/processors");//Subscription_dint
       ...
       //this.process_group_url.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/930b3376-c5e7-1ec0-92d3-499826ae5db8/processors");//Purchase_ddach
        this.process_group_url.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef78a64a-015f-1000-ca5e-e475b3de15c1/processors");//Purchase_dint
        ...
        this.process_group_url_con.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef78355a-015f-1000-56d5-37f8af22664c/connections");//Usage_dint
        ...
        this.process_group_url_con.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef7825d2-015f-1000-51ab-1024c6250f6e/connections");//Mail_dint
       ...
       //this.process_group_url_con.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/46ee3307-43db-10ed-3f35-b4085e6bd8d8/connections");//User_ddach
        this.process_group_url_con.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef78487a-015f-1000-ee70-20fee4dd9b73/connections");//User_dint
        ...
        this.process_group_url_con.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef786c82-015f-1000-8e57-8dfed41663d8/connections");//Commission_dint
        ...
        this.process_group_url_con.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef788922-015f-1000-9d93-7bb916a6f066/connections");//Subscription_dint
        ...
        this.process_group_url_con.add("http://nifi01s.cyberservices.local:8080/nifi-api/process-groups/ef78a64a-015f-1000-ca5e-e475b3de15c1/connections");//Purchase_dint
